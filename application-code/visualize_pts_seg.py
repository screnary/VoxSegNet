...
show_dict = {
             'Airplane': 8, 'Bag': 2, 'Cap': 10,
             'Car': 5, 'Chair': 0, 'Earphone': 0, 'Guitar': 13, 'Knife': 1,
             'Lamp': 40, 'Laptop': 10, 'Motorbike': 14, 'Mug': 0, 'Pistol': 0,
...
if __name__ == '__main__':
    ...
    for cname in classes:
        ...
        PtNet_dir = os.path.join(BASE_DIR, '../../result-data', 'test_results_pointnet',
               CLSNAME)
        fname_atrous = os.path.join(Atrous_dir, str(shape_idx)+'_pred'+'.obj')
        fname_ptnet = os.path.join(PtNet_dir, str(shape_idx)+'.0_pred'+'.obj')
        fname_atrous_gt = os.path.join(Atrous_dir, str(shape_idx)+'_gt'+'.obj')
        fname_ptnet_gt = os.path.join(PtNet_dir, str(shape_idx)+'.0_gt'+'.obj')
        ...
        savedir = os.path.join(BASE_DIR, '../../result-data', 'Rendered_imgs', CLSNAME+'_shape_'+str(shape_idx)+'_pred_ptnet.png')
        ...
        savedir = os.path.join(BASE_DIR, '../../result-data', 'Rendered_imgs', CLSNAME+'_shape_'+str(shape_idx)+'_gt_ptnet.png')
