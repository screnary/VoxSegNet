    ...
    with tf.device('/gpu:'+str(GPU_INDEX)):
        ...
        if FLAGS.ignore_Empty:
            ...
            if FLAGS.atrous_block_num == 1:
                ...
                # 2 block [1,1,1] [1,3,5], SDE+concate
                # pred, feature = MODEL.get_model_2block(vol_ph,is_training_ph,part_num+1)
                
                # 2 block [1,2,3] [1,3,5], SDE+AFA
                pred, feature = MODEL.get_model_2block_att(vol_ph,is_training_ph,part_num+1)
                ...
                # pred, feature = MODEL.get_model_2block_v1_afa(vol_ph,is_training_ph,part_num+1)
