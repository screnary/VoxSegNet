...
#parser.add_argument('--log_dir', default='log-3DCNN_Atrous-2blockEncoder', help='Log dir [default: log]')
    ...
    with tf.device('/gpu:'+str(GPU_INDEX)):
        ...
        if FLAGS.ignore_Empty:
            ...
            if FLAGS.atrous_block_num == 1:
                ...
                # 2 block [1,2,3] [1,3,5]
                pred, feature = MODEL.get_model_2block(vol_ph,is_training_ph,part_num+1)
                #pred, feature = MODEL.get_model_2block_v1(vol_ph,is_training_ph,part_num+1)
    ...
    for fn in range(len(TEST_FILES)):
        ...
        for batch_idx in range(num_batches):
            ...
            if not FLAGS.ignore_Empty:
                ...
                # plb_gt = plb_gt + 1.0  # if plb_gt start from 0; But In COSEG, start from 1
