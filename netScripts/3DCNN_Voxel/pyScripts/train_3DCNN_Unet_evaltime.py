...
parser.add_argument('--model', default='3DCNN_Unet', help='Model name: baseline segmentation network 3DCNN [default: 3DCNN_model]')
...
os.system('cp train_3DCNN_Unet.py %s' % (LOG_DIR))  # bkp of train procedure
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            # if (save_Flag is True) or epoch==MAX_EPOCH-1:
