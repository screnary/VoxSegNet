...
# Write numpy array data and label and seg to h5_filename
def save_h5_vol(h5_filename, data, label, seg, data_dtype='uint8', label_dtype='uint8', seg_dtype='uint8'):
    h5_fout = h5py.File(h5_filename)
    h5_fout.create_dataset(
            'data', data=data,
            compression='gzip', compression_opts=4,
...
def save_h5_bon(h5_filename, data, label, boundary, data_dtype='uint8', label_dtype='uint8', bon_dtype='uint8'):
    h5_fout = h5py.File(h5_filename)
    h5_fout.create_dataset(
            'data', data=data,
            compression='gzip', compression_opts=4,
